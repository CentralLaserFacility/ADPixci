...
Other cameras that can be used with the PIXCI&reg; frame grabbers can inherit from ADPixci in a similar fashion, adding in their respective serial commands and quirks.
